...
//________magnificPopup function	by = magnific-popup.js________//	
	...
	function fancybox_popup_projects(){
     	// Fancybox Config
				jQuery('[data-fancybox="projects"]').fancybox({
				  buttons: [
				    "slideShow",
				    "thumbs",
				    "zoom",
	...
	function fancybox_popup_products(){
     	// Fancybox Config
				jQuery('[data-fancybox="products"]').fancybox({
				  buttons: [
				    "slideShow",
				    "thumbs",
				    "zoom",
...
---------------------------------------------------------------------------------------------*/
	jQuery(document).ready(function() {
	       ...
	       //________  Sidebar sticky  when scroll down function by = theia-sticky-sidebar.js ========== //		
			...
			video_responsive(),
			//________fancyboxPopup function	by = fancybox-popup.js________//	
			fancybox_popup_projects(),
			//________fancyboxPopup function	by = fancybox-popup.js________//	
			fancybox_popup_products(),
